...
Your goal: making the part invisible after 10 seconds. (You can ask questions, but your most useful ressource will be the [documentation]([https://create.roblox.com/docs/fr-fr/reference/engine](https://create.roblox.com/docs/fr-fr/reference/engine/libraries/task#wait))!
